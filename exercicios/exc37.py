# Faça um programa para implementar o algoritmo de Busca Binária ensinado em aula. Conforme o fluxograma em anexo
#(termino - inicio)/2  ----> inicio + (termino - inicio)/2
